...
export const apiRoutesSecond = {
  ...
  "projects.launchPass": {
    ...
    summary: "Launch the next localization pass.",
  ...
  "projects.pausePass": {
    method: "POST",
    pathTemplate: "/api/projects/{projectId}/runs/{runId}/pause",
    operationId: "projectsPausePass",
    summary: "Pause the active localization pass after its worker has stopped.",
    pathParams: ["projectId", "runId"],
    requestSchema: "ApiLocalizationPassControlRequest",
    responseSchema: "ApiLocalizationPassControlResponse",
  },
  "projects.resumePass": {
    method: "POST",
    pathTemplate: "/api/projects/{projectId}/runs/{runId}/resume",
    operationId: "projectsResumePass",
    summary: "Resume a paused localization pass from its durable checkpoints.",
    pathParams: ["projectId", "runId"],
    requestSchema: "ApiLocalizationPassControlRequest",
    responseSchema: "ApiLocalizationPassControlResponse",
  },
