import type { RegisteredModelProfileCertificate } from "../role-model-profiles.js";
 ...
 */
export const modelProfileCertificates: readonly RegisteredModelProfileCertificate[] = [
  {
    schemaVersion: "itotori.model-profile-certificate-registration.v1",
    certificate: {
    ...
    attestation: {
      ...
      signature:
        "KfUbLG0F1QC9gH3MrKQBrQN/FtSg71LXC8JVTHq0fo1N8NBQ/1TCYHNKC971cSHP2SRTuLAbhv21ikPFkJZcBQ==",
    },
  },
];
