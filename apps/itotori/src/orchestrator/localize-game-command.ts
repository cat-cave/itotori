...
export async function runLocalizeGameCommand(
  ...
  log(
    `[localize-game] stage 3/4 localize done (units=${localize.result.unitsRun} accepted=${localize.result.acceptedDraftCount} cost=$${localize.result.totalUsageCostUsd} patched=${args.targetRoot})`,
  );
