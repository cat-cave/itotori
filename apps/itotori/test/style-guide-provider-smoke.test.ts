...
describe("style-guide provider smoke", () => {
  ...
  it("ITOTORI-132: refuses an unadmitted mocked fallback smoke before fetch", async () => {
    const fixture = readSmokeFixture();
  ...
  it("ITOTORI-132: refuses an unadmitted mocked direct-serve smoke before fetch", async () => {
