...
use kaifuu_core::{
    ...
    Xp3ProfileProofRequest, atomic_write_text, encode_xp3, generate_xp3_capability_profile,
    pack_plain_xp3_from_directory, plain_xp3_writer_capability, read_json, read_plain_xp3_archive,
    redact_for_log_or_report, replace_plain_xp3_entry_payload, run_plain_xp3_smoke_from_path,
    sha256_hash_bytes, stable_json, unpack_plain_xp3_to_directory, xp3_profile_proof,
};
use kaifuu_delta::{ContractStageStatus, run_encrypted_xp3_contract_scaffold};

use crate::{flag, flag_optional, positional};
