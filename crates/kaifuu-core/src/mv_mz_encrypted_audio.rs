...
//!
//! Path declarations, evidence model, and processing are separated into real Rust modules
//! while preserving this module's historical public API.
...
use model::{
    ...
    SYNTHETIC_KEY_CORRECT, SYNTHETIC_KEY_WRONG, is_ogg,
};
...
mod run;
pub use run::{MvMzEncryptedAudioRequest, run_mv_mz_encrypted_audio};
