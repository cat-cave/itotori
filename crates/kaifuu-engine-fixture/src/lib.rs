...
use kaifuu_core::{
    ...
    AssetList, AssetListRequest, AssetProfile, BGI_BYTECODE_SUPPORT_BOUNDARY, BGI_ENGINE_FAMILY,
    ...
    DetectionResult, EncodedStringSlot, EncodedStringSlotProtectedSpan, EngineAdapter,
    EngineProfile, EvidenceStatus, ExtractRequest, ExtractionResult,
    FIXTURE_HELPER_ALLOWLIST_REF_ID, FIXTURE_HELPER_REGISTRY_ID, GameProfile, HelperCapability,
    KaifuuResult, KeyMaterialKind, KeyRequirement, LayeredAccessCapabilityContract,
    ...
    PatchPreflightRequest, PatchRef, PatchRequest, PatchResult, PlainXp3Entry,
    PlainXp3InventoryError, ProfileRequest, ProfileRequirement, ProtectedSpan,
    ProtectedSpanMapping, RequirementCategory, RequirementStatus, SecretRef, SemanticErrorCode,
    SourceFingerprint, SurfaceTransform, TextSurface, VerificationResult, VerifyRequest,
    XP3_PLAIN_MAGIC, atomic_write_bytes, atomic_write_text, content_hash, deterministic_id,
    normalize_protected_spans, parse_bgi_bytecode_bytes, parse_hex_bytes, patch_bgi_bytecode_bytes,
...
use reallive_support::{
    case_insensitive_find, gameexe_ini_detail, reallive_extension_counts,
    reallive_gameexe_ini_key_hits, reallive_seen_txt_envelope_ok,
};
