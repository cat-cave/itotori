...
use kaifuu_core::{
    ...
    AssetList, AssetListRequest, AssetProfile, BridgeV02AssetInput, BridgeV02ProduceOpts,
    BridgeV02UnitInput, Capability, CapabilityLevelStatus, CapabilityReport, CapabilityStatus,
    ...
    PatchPreflightRequest, PatchRequest, PatchResult, PlainXp3Entry, PlainXp3InventoryError,
    ProfileRequest, ProfileRequirement, ProtectedSpan, ProtectedSpanMapping, RequirementCategory,
    RequirementStatus, SecretRef, SemanticErrorCode, SourceFingerprint, SurfaceTransform,
    TextSurface, VerificationResult, VerifyRequest, XP3_PLAIN_MAGIC, atomic_write_text,
    content_hash, deterministic_id, normalize_protected_spans, parse_hex_bytes,
    produce_bridge_v02_json, read_plain_xp3_inventory, require_str, require_u64,
    safe_join_relative, sha256_file_ref, sha256_hash_bytes,
};
