...
//! trees; the default is large enough to cover the observed two-level
...
//! `docs/research/reallive-engine.md` §C and the real-corpus verification
...
/// confirms the marker is the upper-case form `REALLIVEDATA`;
...
/// Default bound for the directory descent. Covers the observed depth-2
...
mod tests {
    ...
    fn detects_reallivedata_under_nonascii_parent() {
        // Mirrors a non-ASCII two-level installation layout:
        // <root>/観測用データ/REALLIVEDATA/
