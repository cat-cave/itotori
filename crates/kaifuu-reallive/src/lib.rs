...
//!   an observed scene 8509 (91 goto pointers, longer + shorter bodies).
...
//!   against an observed decompressed scene 1 in the encryption-mechanism
//!   research note §4.2.
...
//! §C and confirmed against an observed corpus's
...
//! - The observed corpus has 198 populated slots, scene-id range 1..=9999.
...
//! the encryption-mechanism research note) and
