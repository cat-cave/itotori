//! `reallive-xor2-compiler-110002-decryptor` — RealLive second-level XOR (`xor_2`)
...
//! `xor_length = 257`. The compiler-110002 family is **absent** from rlvm's
//! table — so its key is recovered here rather than
//! looked up.
