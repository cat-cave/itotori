...
pub mod branch_coverage_export;
pub mod branch_coverage_gaps;
...
pub use branch_coverage_export::{
...
pub use branch_coverage_gaps::{
    ...
    emit_branch_coverage_gap_findings, severity_for,
};
