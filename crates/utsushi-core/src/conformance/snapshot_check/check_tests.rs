...
use crate::snapshot::{InMemorySnapshotStore, SnapshotError, SnapshotId, SnapshotSchemaVersion};
...
fn snapshot_conformance_check_round_trips_through_serde_json() {
    ...
    let restored: SnapshotConformanceCheck = serde_json::from_value(value).expect("deserializes");
