...
use utsushi_core::conformance::capture_recording::RecordingMetadata;
...
use utsushi_core::{EvidenceRef, EvidenceTier, ProfileId, RuntimeArtifactKind};

#[path = "recording_metadata/support.rs"]
mod support;
