...
#[path = "mvmz_patched_runtime_proof/helpers.rs"]
mod helpers;
pub use helpers::canonical_patched_output_hash;
use helpers::{
    Check, alpha_proof_bridge_units, observed_translated_units, patched_trace_bridge_units,
};
...
#[cfg(test)]
#[path = "mvmz_patched_runtime_proof/tests.rs"]
mod tests;
