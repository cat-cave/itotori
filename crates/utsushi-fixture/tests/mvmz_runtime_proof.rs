...
/// Resolve a launchable real browser from PATH. The browser/oracle devshell
/// owns the pinned Chromium derivation and places it there; portable lanes do
/// not manufacture a browser path.
