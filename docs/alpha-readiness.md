...
| ------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| CI                  | `.github/workflows/ci.yml` → `just ci`                                                                                                                                                   | full TS + Rust + DB + real-bytes gate.                                              |
| Alpha proof         | `.github/workflows/alpha-proof.yml` → `just alpha-proof`                                                                                                                                 | public-fixture vertical + independent linkage validator.                            |
