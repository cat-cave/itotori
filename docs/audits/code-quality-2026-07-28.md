...
| Dashboard client weakened indexed access and used unrelated SVG casts | **Verified fixed**                           | The browser configuration inherits the root strict settings at [tsconfig.client.json:2](../../packages/spec-dag-dashboard/tsconfig.client.json#L2), including `noUncheckedIndexedAccess` at [tsconfig.base.json:8](../../tsconfig.base.json#L8). DOM access is checked against requested element constructors at [main.ts:27](../../packages/spec-dag-dashboard/src/client/main.ts#L27)-[38](../../packages/spec-dag-dashboard/src/client/main.ts#L38) and SVG collections are generically typed at [main.ts:509](../../packages/spec-dag-dashboard/src/client/main.ts#L509)-[534](../../packages/spec-dag-dashboard/src/client/main.ts#L534). The package type check passed.                                               |
...
| Database shutdown failure was discarded                               | **Verified fixed**                           | [loadAuditFindingsByNode](../../packages/spec-dag-dashboard/src/db-audit-findings.ts#L113) now raises `shutdown_failed` after a successful query and preserves a primary query failure with `shutdownError` when both operations fail. The forced-shutdown regression at [db-audit-findings.test.ts](../../packages/spec-dag-dashboard/test/db-audit-findings.test.ts#L54) passed 2/2; replacing the close with a swallow made both assertions fail.                                                                                                                                                                                                                                                                        |
