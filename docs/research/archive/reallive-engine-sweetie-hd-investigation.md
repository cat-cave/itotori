# RealLive Engine research archive — §A–§K (Sweetie HD investigation)

> **Archived.** Point-in-time RealLive investigation narrative (sections A–K)
> formerly living at `docs/research/reallive-engine.md`. The load-bearing
> schema authority is **Appendix M** in the live
> [`../reallive-engine.md`](../reallive-engine.md) (cross-engine substrate
> conformance + Siglus lineage). Do not treat this archive as current product
> or adapter status.
>
> ---
