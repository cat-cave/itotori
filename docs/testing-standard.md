...
| Test builders         | Repeated valid bridge, patch, runtime, or DB objects.                                           | Put shared TypeScript builders in `packages/test-fixtures` when duplication crosses packages. Rust builders should live in the crate test module or a dedicated fixture crate. |
