...
import { CatalogJsonRecord, CatalogSourceProvenanceInput } from "./catalog-record-types.js";
import {
...
import { externalIdFromRow, releaseFromRow, workFromRow } from "./catalog-scan-input-validation.js";
import {
  assertSha256,
