...
import { CatalogConflictEvidenceInput, CatalogConflictInput } from "./catalog-work-scan-types.js";
import {
  catalogConfidences,
...
import { dateInput, jsonRecord, optionalString, optionalYear } from "./catalog-row-mapping.js";
