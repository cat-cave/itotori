...
import { CatalogArtifactMappingError, CatalogJsonRecord } from "./catalog-record-types.js";
import { CatalogWorkInput } from "./catalog-work-scan-types.js";
import { catalogConfidences, catalogEngineSources } from "./catalog-repository-port-and-enums.js";
import {
  NormalizedCatalogEngineInput,
  NormalizedCatalogWorkInput,
} from "./catalog-input-normalization.js";
import { assertReleaseBelongsToWork } from "./catalog-identity-validation.js";
import {
  assertConflictInput,
...
} from "./catalog-record-input-validation.js";
import { jsonRecord, optionalString, optionalYear } from "./catalog-row-mapping.js";
