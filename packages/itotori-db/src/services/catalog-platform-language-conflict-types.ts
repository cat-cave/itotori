...
import {
  ...
  conflictEvidenceFromLanguageEvidence,
  diagnostic,
  evidenceMetadata,
  isOfficialPositiveEvidence,
  normalizeEvidence,
  result,
  sourceMetadata,
} from "./catalog-platform-language-conflict-derivation.js";
import { compactJson, sourceLabel } from "./catalog-platform-language-conflict-helpers.js";
...
export type CatalogPlatformLanguageConflictConflictCandidate = {
