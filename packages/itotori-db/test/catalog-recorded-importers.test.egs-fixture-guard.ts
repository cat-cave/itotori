...
import { readFixture, readFixtureText } from "./catalog-recorded-importers.test.fixture-support.js";
describe("catalog recorded source importers", () => {
  it("guards EGS fixtures against Epic storefront semantics", () => {
    ...
    for (const text of [fixtureText, platformLanguageConflictText]) {
